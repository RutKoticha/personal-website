...
export default function Contact() {
  return (
    <section id="contact" className="bg-transparent py-20 border-b border-border-subtle">
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-6 space-y-8">
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-sm bg-frosted-high text-accent-golden border border-border-subtle">
                ...
                <div className="ml-4">
                  <h3 className="font-mono text-[10px] font-bold text-on-surface uppercase tracking-wider">Email</h3>
                  <p className="mt-1">
                    <a 
                      href={`mailto:${PERSONAL_INFO.email}`} 
                      className="font-mono text-sm text-accent-golden hover:underline underline-offset-4 focus-ring rounded"
                    >
                      {PERSONAL_INFO.email}
                    </a>
                  </p>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="font-mono text-[10px] font-bold text-on-surface uppercase tracking-wider">Phone</h3>
                  <p className="mt-1">
                    <a 
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="font-mono text-[10px] font-bold text-on-surface uppercase tracking-wider">Location</h3>
                  <p className="mt-1 font-sans text-sm text-on-surface-variant font-medium">
          ...
          <div className="lg:col-span-6 flex flex-col justify-between rounded-sm border border-border-subtle bg-frosted p-6">
            <div>
              <h3 className="font-mono text-xs font-bold text-on-surface uppercase tracking-wider">Connect Digitally</h3>
